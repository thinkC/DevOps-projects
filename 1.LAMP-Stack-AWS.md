...
![privateKey-permission](./img/img9a.png)
...
```
![ssh-connection](./img/img8.png "show hostname after connection")
...
![update package Manager](./img/img10.png)
![install apache](./img/img10a.png)
...
![check running service](./img/img10b.png)
...
![apache on the browser](./img/img10c.png)
