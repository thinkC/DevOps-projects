...
fatal: [172.31.52.115]: UNREACHABLE! => {"changed": false, "msg": "Failed to connect to the host via ssh: ec2-user@172.31.52.115: Permission denied (publickey).", "unreachable": true}
ok: [172.31.63.137]
ok: [172.31.51.147]
ok: [172.31.54.139]
...
172.31.52.115              : ok=0    changed=0    unreachable=1    failed=0    skipped=0    rescued=0    ignored=0   
...
I got this error with DB server . Though SSH is opened on it, I also connected to it via ssh on the Jenkins-Ansible Server. I am not sure why I ansible could not connect. _fatal: [172.31.52.115]: UNREACHABLE! => {"changed": false, "msg": "Failed to connect to the host via ssh: ec2-user@172.31.52.115: Permission denied (publickey).", "unreachable": true}_
