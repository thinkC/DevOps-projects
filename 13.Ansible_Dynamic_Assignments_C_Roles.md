...
![folder layout](https://github.com/thinkC/devops-projects1/blob/main/img-ansible1/img1.PNG?raw=true)
...
We create roles for web servers, mysql, apache and nginx. We can either create using commnity roles or creating one ourselves. I this project, we shall be creating one ourself.
