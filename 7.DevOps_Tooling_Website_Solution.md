...
![fstab](./img-web-tooling/img21.png)
...
```
[ec2-user@ip-172-31-52-121 ~]$ sudo umount -t nfs rw,nosuid 172.31.55.116:/mnt/logs /var/log/httpd
...
```
![functions.php](./img-web-tooling/img16.png)
...
![securityGroup-webserver](./img-web-tooling/img17.png)
